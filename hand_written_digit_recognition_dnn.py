...
# scaling and labeling the neccesary features
...
# spliting the input into training and validation data
...
# creating input function for model to train 
...
# splitting and testing the data on train classifier
